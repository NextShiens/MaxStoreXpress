...
console.log("Current Deployment URL: ", process.env.VERCEL_URL);
...
const oidcConfig = {
  ...
  redirect_uri: process.env.NODE_ENV === 'production' ? `https://${process.env.VERCEL_URL}/` : "http://localhost:3000/",
