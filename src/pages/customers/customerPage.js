...
if (data) {
    return (
    <div className="pl-7 grid grid-cols-2 gap-y-5 gap-x-10 md:gap-x-0 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-6 auto-rows-min grid-rows-[auto,auto]">
   <div className='m-9  h-40 mt-16 flex flex-col items-center justify-center text-[22px] xl:w-full lg:w-[80%] w-[60%]  shadow-lg  shadow-inset rounded-lg md:col-span-1 col-span-2'>
    <PeopleAltIcon className='text-blue-500 scale-[200%] mb-4' />
    <span className='text-[22px]'>{allCus}</span>
    All Customers
</div>
<div className='m-9 mr-10 h-40 mt-16 flex flex-col items-center justify-center text-[22px] xl:w-full w-[60%] lg:w-[80%] shadow-lg  shadow-inset rounded-lg lg:col-span-1 col-span-2'>
    <PersonAddIcon className='text-pink-600 scale-[200%] mb-4' />
    <span className='text-[22px]'>{newCus}</span>
    New Customers
</div>
<div className='m-9  h-40 mt-16  flex flex-col items-center justify-center text-[22px] xl:w-full w-[60%] lg:w-[80%] shadow-lg  shadow-inset rounded-lg md:col-span-1 col-span-2'>
    <AccountCircleIcon className='text-purple-600 scale-[200%] mb-4' />
    <span className='text-[22px]'>{regularCus}</span>
    Regular Customers
</div>
            <div className='m-7 ml-12 mt-16 gap-y-[13px] gap-x-[13px] h-40  flex flex-col items-center justify-center xl:w-[599px] lg:w-[80%] w-[60%]  lg:col-span-1  shadow-lg  shadow-inset rounded-lg xl:col-span-3 col-span-2 xl:p-0 p-2'>
                    <h4 className='text-[23px] m-0 font-bold'>Conversion Rate</h4>

                    <div className=' flex flex-row items-center content-center'>
                        <div className=" ">
                            <table className='xl:mr-[9px]'>
                ...
                <div className=' mr-[33px]  ml-6 w-[56%] col-span-2 row-span-2 flex items-center justify-center flex-col '>
                   
                        <h5 className=' font-bold w-[100%] text-[18px]'>Customer Retention Rate</h5>
                        <div >< Piechart /></div>
                    
                </div >
                <div className=' list-none text-[18px] w-full mb-4 col-span-2 row-span-2'>
